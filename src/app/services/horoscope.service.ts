...
Results should be returned with summary first followed by a horizontal line, then detailed horoscope.
The summary section should begin with '<b>Guidance Summary:</b>'.
The detailed horoscope section should begin with '<b>Guidance Details:</b>'.
